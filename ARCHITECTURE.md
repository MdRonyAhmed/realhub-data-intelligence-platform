# System Architecture & Evolution Guide
## RealHub Data Intelligence Platform

---

> **Note on Source Code & NDA:**
> *The production implementation of this platform contains proprietary business logic, client credentials, and internal API endpoints protected under strict Non-Disclosure Agreements (NDA). This document is structured as a technical case study and architectural blueprint demonstrating enterprise-grade distributed data engineering patterns. No source code, credentials, or client-specific business logic is disclosed.*
...
4. [System Evolution](#-system-evolution)
   - [Phase 1 — Async Queue Architecture](#phase-1--asynchronous-queue-architecture-realhub-listings-api-v2)
   - [Phase 2 — Synchronous Instant Execution](#phase-2--synchronous-instant-execution-realhub-instant-scraper)
   - [Phase 3 — Anti-Bot Hardening & Cloud-Native Sinks](#phase-3--anti-bot-hardening--cloud-native-sinks-realhub-scraper-api)
5. [API Endpoints](#-api-endpoints)
6. [Environment Configuration](#-environment-configuration)
7. [Local Development Setup](#-local-development-setup)
8. [DevOps & CI/CD](#️-devops--cicd)
9. [Data Models](#-data-models)
10. [Key Engineering Decisions](#-key-engineering-decisions)
11. [Repository Structure](#-repository-structure)
12. [Scraper Engine Deep Dive](#-scraper-engine-deep-dive)
